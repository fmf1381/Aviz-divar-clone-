...
class MobileVerifiLoginScreen extends StatelessWidget {
  const MobileVerifiLoginScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('تایید شماره موبایل', style: Style.grey700_16px_700w),
